    ...
    <main class="admin-container">
        ...
        <c:if test="${not empty pedido}">
            ...
            <div class="form-update-estado">
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/pedidos" style="display: flex; gap: 15px; align-items: center; margin-top: 15px;">
                    ...
                    <c:if test="${pedido.estado != 'CANCELADO' && pedido.estado != 'ENTREGADO'}">
                        <button type="button" 
                                onclick="if(confirm('¿Cancelar este pedido?')) { document.getElementById('formCancelar').submit(); }" 
            ...
            <div style="margin-top: 30px;">
                <a href="${pageContext.request.contextPath}/admin/pedidos" class="btn" style="background: #6c757d; color: white;">
                    ← Volver a Pedidos
                </a>
            </div>
        </c:if>
